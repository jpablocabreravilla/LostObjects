namespace LostObjects.Helpers
{
	...
	public static class Settings
	{
		...
		private const string objectToEdit = "ObjectToEdit";
		private static readonly string stringDefault = string.Empty;
		private static readonly bool booleanDefault = false;

		#endregion

		public static string ObjectToEdit
		{
			get
			{
				return AppSettings.GetValueOrDefault(objectToEdit, stringDefault);
			}
			set
			{
				AppSettings.AddOrUpdateValue(objectToEdit, value);
			}
		}
